	...
	kafka.make_request(
		...
		function (err, data) {
			...
			if (err) {
				...
				res.cookie("restaurant", data.restaurant_ID, {
					maxAge: 9000000,
					httpOnly: false,
					path: "/",
				});
...
exports.findSearchedItems = (req, res) => {
	kafka.make_request(
		"lab3.restaurants.findSearchedItems",
		req.query,
		function (err, data) {
			console.log(data);
			if (err) {
