...
exports.create = (req, res) => {
	...
	kafka.make_request(
		"lab3.customer_addresses.create",
		req.body,
		function (err, data) {
			console.log(data);
			if (err) {
...
exports.delete = (req, res) => {
	...
	kafka.make_request(
		"lab3.customer_addresses.delete",
		req.params,
		function (err, data) {
			console.log(data);
			if (err) {
...
exports.findAll = (req, res) => {
	kafka.make_request(
		"lab3.customer_addresses.findAll",
		req.params,
		function (err, data) {
			console.log(data);
			if (err) {
		...
		(err, data) => {
			if (err) {
				res.status(500).send({
					message:
						err.message ||
						"Some error occurred while retrieving the customer addresses.",
				});
			} else {
				res.send(data);
			}
